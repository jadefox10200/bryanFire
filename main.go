...
func main() {
	...
	//put the js folder through a handler to add content-type to the header.
	fs := http.FileServer(http.Dir("assets/js/"))
	http.Handle("/tpl/assets/js/", http.StripPrefix("/tpl/assets/js", addHeaders(fs)))
